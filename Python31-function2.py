...
if choice == "Y":
    mass_proton = (print("Enter the mass of proton in amu: "))
    mass_neutron = (print("ENter the mass of neutron in amu: "))

    Total_mass = MassOfNucleon(Num_proton,Num_neutron,mass_proton,mass_neutron)
    print(f"The total mass of neucleon is: {Total_mass} amu")

else:
    Total_mass = MassOfNucleon(Num_proton,Num_neutron)
    print(f"The total mass of neucleon is: {Total_mass} amu")
